...
(function( $, window, document, undefined ) {
	...
	function _fnLanguageCompat( lang )
	{
		...
		if ( ! lang.sEmptyTable && zeroRecords &&
			defaults.sEmptyTable === "No hay data asignada." )
		{
	...
	DataTable.defaults = {
		...
		"oLanguage": {
			 ...
			 *      $('#example').dataTable( {
			 *        "language": {
			 *          "emptyTable": "No hay data asignada."
			 *        }
			 *      } );
			 *    } );
			 */
			"sEmptyTable": "No hay data asignada.",
